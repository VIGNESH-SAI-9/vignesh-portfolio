          ...
          {characters.map((char, i) => (
            <div key={i} className="shutter-char">
              ...
              <motion.span
                ...
                transition={{ delay: i * 0.04 + 2.9, duration: 0.8 }}
              ...
              <motion.span
                ...
                transition={{ duration: 0.7, delay: i * 0.04 + 2.6, ease: "easeInOut" }}
              ...
              <motion.span
                initial={{ x: "100%", opacity: 0 }}
                animate={{ x: "-100%", opacity: [0, 1, 0] }}
                transition={{ duration: 0.7, delay: i * 0.04 + 2.7, ease: "easeInOut" }}
              ...
              <motion.span
                initial={{ x: "-100%", opacity: 0 }}
                animate={{ x: "100%", opacity: [0, 1, 0] }}
                transition={{ duration: 0.7, delay: i * 0.04 + 2.8, ease: "easeInOut" }}
