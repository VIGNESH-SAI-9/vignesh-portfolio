          ...
          {characters.map((char, i) => (
            <div key={i} className="shutter-char">
              ...
              <motion.span
                ...
                transition={{ delay: i * 0.1 + 3.0, duration: 1.5 }}
              ...
              <motion.span
                ...
                transition={{ duration: 1.2, delay: i * 0.1 + 2.6, ease: "easeInOut" }}
              ...
              <motion.span
                initial={{ x: "100%", opacity: 0 }}
                animate={{ x: "-100%", opacity: [0, 1, 0] }}
                transition={{ duration: 1.2, delay: i * 0.1 + 2.7, ease: "easeInOut" }}
              ...
              <motion.span
                initial={{ x: "-100%", opacity: 0 }}
                animate={{ x: "100%", opacity: [0, 1, 0] }}
                transition={{ duration: 1.2, delay: i * 0.1 + 2.8, ease: "easeInOut" }}
